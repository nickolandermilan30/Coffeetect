...
public class Result_Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (byteArray != null) {
            ...
            Toast.makeText(Result_Activity2.this, "Image byte array is null", Toast.LENGTH_SHORT).show();
        }
            ...
            public void onClick(View v) {
                if (!isSaving) {
                    ...
                    if (isConnectedToInternet()) {
                        ...
                        Intent intent = new Intent(Result_Activity2.this, Tree_Visualization.class);
                        startActivity(intent);
