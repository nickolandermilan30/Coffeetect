...
public class reco1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slideModels.add(new SlideModel(R.drawable.miner, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.minerr, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.minerrr, ScaleTypes.FIT));
