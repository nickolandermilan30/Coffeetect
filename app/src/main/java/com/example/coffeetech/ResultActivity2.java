...
public class ResultActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (image != null) {
            ...
            // Load the image from the file and display it in the ImageView
        ...
        if (byteArray != null) {
            ...
            Toast.makeText(ResultActivity2.this, "Image byte array is null", Toast.LENGTH_SHORT).show();
        }
    ...
    private void saveImageToFirebaseStorage(SavedResult savedResult, Bitmap imageBitmap) {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(ResultActivity2.this, "Failed to save the image: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
